...
if (message.content.startsWith(`${prefix}pogoinfo`)) {	 
	...
	.addField('❓ `p!info`', "Information on little things and facts about POGO.")
        .addField('🎉 `p!randomlink`', "Surprises you with a random remix from a generated queue.") 
