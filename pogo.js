...
if (message.content.startsWith(`${prefix}serverinfo`)) {		
 ...
 if (message.content.startsWith(`${prefix}info`)) {
    ...
    .addFieild("POGO's Sub Count", "Back in 2011, POGO used to have over 1.5 million subs (which explains why in some videos you can see a 1M Play Button) before the visa issue that got him to lose over 70-74% of his subs at the time. Leaving him at around 430-450k subs after he got released, and you couldn't subscribe to him either at the time.") 
