...
//     .setDescription(`Information on **POGO:**`)
    .setColor("RANDOM")
    .addField("<:nick:502697290532913152> [Pogomix](https://soundcloud.com/pogomix/)", "Information on **POGO:**")
...
if(!user) return message.channel.send("You haven't selected/mentioned a user whose avatar you want to see."); 
    ...
    .setAuthor("[PogoBot Information](https://soundcloud.com/pogomix/)", pogoears)
...
if (message.content.toLowerCase().startsWith(`${prefix}serverinfo`)) {		
 ...
 if (message.content.toLowerCase().startsWith(`${prefix}info`)) {
    ...
    .setAuthor("[More Information About POGO](https://soundcloud.com/pogomix/)", pogonick)
